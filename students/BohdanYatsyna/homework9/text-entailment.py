...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_jobs', help='Number of workers (default=1) use all cores', default=24)
    ...
    wandb.init(project='homework9', name="features variation", config=config_wandb)
